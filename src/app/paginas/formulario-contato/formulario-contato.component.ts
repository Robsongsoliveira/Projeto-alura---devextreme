...
import { DxTextBoxModule, DxDateBoxModule, DxTextAreaModule, DxButtonModule } from 'devextreme-angular';
...
export class FormularioContatoComponent implements OnInit{
  ...
  salvarContato() {
    ...
    if (novoContato.aniversario instanceof Date) {
      novoContato.aniversario = novoContato.aniversario.toISOString().split('T')[0];
    }
